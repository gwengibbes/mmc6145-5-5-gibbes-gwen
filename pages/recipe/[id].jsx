...
export default function Recipe({recipeInfo}) {
  return (
    <>
      ...
      {
        recipeInfo
        ? <RecipeInfo image={recipeInfo.image} title={recipeInfo.title} readyInMinutes={recipeInfo.readyInMinutes} instructions={recipeInfo.instructions} summary={recipeInfo.summary} extendedIngredients={recipeInfo.extendedIngredients} />
        : <RecipeError/>
      }
